      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          >
            ...
            href="https://zerodha.com"
             ...
             className="d-block lh-sm text-decoration-none">
              {" "}
              About
            </a>
            <br />
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            ...
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Trading through
          ...
          <p>
            ...
            it need not be done again when you approach another intermediary.
            ...
            bank account. As a client, you should not share your password, PIN
            or OTP with anyone. Please do not share your login credentials with
            anyone. Zerodha does not provide stock tips and has not authorised
